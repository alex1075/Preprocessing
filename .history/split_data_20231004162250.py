...
def split_img_label(data_train,data_test, data_val, PATH, out):
    try:
        os.mkdir(out)
    except:
        pass
    ...
    # print(train_ind)
    # print(data_train)
    for i in tqdm.tqdm(range(len(train_ind)), desc='Preparing train folder'):
    ...
    # Test folder
    for j in tqdm.tqdm(range(len(test_ind)), desc='Preparing test foldercd'):
    ...
    # Val folder
    for k in tqdm.tqdm(range(len(val_ind)), desc='Preparing val folder'):
...
def prep_split(PATH = '/home/as-hunt/machine-code/temp/'):
    ...
    # Function split 
    split_img_label(data_train,data_test,data_val, PATH, '/home/as-hunt/machine-code/temp4/')
